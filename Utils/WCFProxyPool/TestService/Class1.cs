...
namespace TestService
{
    ...
    public class service1 : TestServiceInterface.IService1
    {
    ...
    [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall)]
    public class Service2 : TestServiceInterface.IService2
    {
        ...
        {
            Console.Write(" 1 ");
            return string.Format("{0}: {1}", myValue, DateTime.Now.ToLongTimeString());
        }
