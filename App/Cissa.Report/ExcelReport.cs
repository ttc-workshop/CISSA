...
namespace Intersoft.Cissa.Report
{
    public class ExcelReport : IExcelReport
    {
        public ExcelReport(string mTitle, string mSubject, string sheetName)
        {
            ...
            Styles = ExcelStyles.CreateDefaultStyels(Workbook);
        ...
        private Dictionary<TextStyle, CellStyle> Styles { get; set; }
        ...
        {
            return GetExcelMemoryStream().ToArray();
        }
        ...
        public void AddLogo(int rowNumber, int columnIndex)
        {
            ...
            int logoId = Workbook.AddPicture(stream.ToArray(), PictureType.PNG);
